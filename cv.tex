...
%\end{itemize}
  ...
  %\item \textbf{University of Santiago} \ Santiago, Chile.
\noindent
  \begin{tabular}{llll}
  ...
  %\item \textbf{M.S.E. in Computer Science (c)}\hfil March 2010 \textendash  \ Expected December 2017. \ GPA: 5.2/7.0
  %\item \textbf{Computer Science Engineering}\hfil March 2010 \textendash  \ Expected December 2017. \ GPA: 5.2/7.0
  %\item \textbf{B.S.E. in Computer Science Engineering}\hfil March 2010 \textendash  \ September 2015. \ GPA: 5.2/7.0
\begin{itemize}[leftmargin=*]
...
%\vspace{0.20em}
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \titleExperienceWithoutLocation{Teaching Assistant}{University of Santiago}{March 2012}{December 2016}
      \begin{itemize}[label=\textbullet]
        \itemsep0em
        \item Conducted interactive discussions on a weekly basis. Subjects: \underline{\smash{Evolutionary Computation}} (2016), \ul{Programming Paradigms} (2015\ \textendash \ 2016), \underline{\smash{Methods of Programming}} (2013), \underline{\smash{Linear Algebra}} (2013\ \textendash \ 2014) \ul{Introduction to Computer Programming} (2012\ \textendash \ 2016), \underline{\smash{Calculus I}} (2012\ \textendash \ 2015).
